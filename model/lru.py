...
class LRUEmbedding(nn.Module):
    def __init__(self, args):
        ...
        embed_size = args.lru_hidden_units
...
class LRUModel(nn.Module):
    def __init__(self, args):
        super().__init__()
        self.args = args
        self.hidden_size = args.lru_hidden_units
        layers = args.lru_num_blocks
...
class LRUBlock(nn.Module):
    def __init__(self, args):
        super().__init__()
        self.args = args
        hidden_size = args.lru_hidden_units
        self.lru_layer = LRULayer(
            d_model=hidden_size, dropout=args.lru_attn_dropout)
        self.feed_forward = PositionwiseFeedForward(
            d_model=hidden_size, d_ff=hidden_size*4, dropout=args.lru_dropout)
